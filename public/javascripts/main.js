	...
	--------------------- */
		$('[data-countdown]').each(function() {
		  ...
		  $this.countdown(finalDate, function(event) {
			$this.html(event.strftime('<span class="cdown days"><span class="time-count">%-D</span> <p>Dias</p></span> <span class="cdown hour"><span class="time-count">%-H</span> <p>Horas</p></span> <span class="cdown minutes"><span class="time-count">%M</span> <p>Min</p></span> <span class="cdown second"> <span><span class="time-count">%S</span> <p>Seg</p></span>'));
		  });
		});	
	// scroolup
	$.scrollUp({
